"""data/build_folds.py -- Walk-forward 5-fold CSV 빌드.
...
출력 (data/folds/):
  F{n}_train.csv, F{n}_val.csv, F{n}_test.csv  × 5 fold

분할 (모든 gap 3M, test 비중첩 + 인접 test 3M gap, val 12M, test 30M):

  | Fold | Train (expanding, 1999-01 anchor) | Val (12M) | Test (30M) |
  |------|------------------------------------|-----------|------------|
  | F1 | 1999-01-01 ~ 2010-09-30 (11.75y) | 2011-01-01 ~ 2011-12-31 | 2012-04-01 ~ 2014-09-30 |
  | F2 | 1999-01-01 ~ 2013-08-31 (14.7y)  | 2013-11-01 ~ 2014-10-31 | 2015-01-01 ~ 2017-06-30 |
  | F3 | 1999-01-01 ~ 2016-05-31 (17.4y)  | 2016-08-01 ~ 2017-07-31 | 2017-10-01 ~ 2020-03-31 |
  | F4 | 1999-01-01 ~ 2019-02-28 (20.2y)  | 2019-05-01 ~ 2020-04-30 | 2020-07-01 ~ 2022-12-31 |
  | F5 | 1999-01-01 ~ 2021-11-30 (22.9y)  | 2022-02-01 ~ 2023-01-31 | 2023-04-01 ~ 2025-09-30 |

Leak 차단:
  - 같은 fold 내 train->val 3M gap, val->test 3M gap (intra-fold leak 없음)
  - test 끼리 정확히 3M gap, 비중첩
  - F2 val covers F1 test 후반 (walk-forward sequential 표준 -- paper footnote 필요)

활용도:
  - F5 test 끝 2025-09-30 -> 데이터 끝 2025-12-26 차이 약 3M 만 미사용
"""
import os
import pandas as pd
...
FOLDS = [
    ...
    ("F1", "2010-09-30", "2011-01-01", "2011-12-31", "2012-04-01", "2014-09-30"),
    ("F2", "2013-06-30", "2013-10-01", "2014-09-30", "2015-01-01", "2017-06-30"),
    ("F3", "2016-03-31", "2016-07-01", "2017-06-30", "2017-10-01", "2020-03-31"),
    ("F4", "2018-12-31", "2019-04-01", "2020-03-31", "2020-07-01", "2022-12-31"),
    ("F5", "2021-09-30", "2022-01-01", "2022-12-31", "2023-04-01", "2025-09-30"),
]
