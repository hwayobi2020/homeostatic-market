"""1-step ahead Gaussian forecaster — sp_return[t+1] 단일 예측.
...
def run(spec, train_csv, val_csv, test_csv, save_dir, seed,
    ...
    tag_full = f"m1step_v{spec['variant_id']}_{spec['name']}{norm_tag}{fold_str}_seed{seed}"
...
def main():
    ...
    if len(results) > 1:
        ...
        out_csv = os.path.join(
            args.out_dir,
            f"m1step_v{spec['variant_id']}_{spec['name']}{norm_tag}{fold_str}_multiseed.csv")
