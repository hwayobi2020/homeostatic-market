...
MASK_FUTURE_CH = [2]   # excess_liq_wr only — tbill_wr/tbill_26w_lag 는 future 에서도 active
...
def main():
    ...
    if len(results) > 1:
        ...
        df.to_csv(os.path.join(args.out_dir, "singlestage_multiseed_results.csv"), index=False)
