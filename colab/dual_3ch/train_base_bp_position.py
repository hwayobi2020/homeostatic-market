...
COLS_COND = ["tbill_wr", "m2_yoy_lag", "gdp_yoy_lag", "cpi_yoy_lag", "bondpp_13w_lag"]   # 5ch (원천 변수 + bondpp, LUPI input)
MASK_FUTURE_CH = [1, 2, 3, 4]   # mask m2/gdp/cpi/bondpp in future (only tbill 시나리오)
