"""1-step (vix included) matrix batch runner — 9 variants × 3 folds × N seeds.

train_matrix_1step_vix.py 호출 자동화. 변종별 정규화 옵션 자동 적용.
...
TRAIN_SCRIPT = os.path.join(HERE, "dual_3ch", "train_matrix_1step_vix.py")
